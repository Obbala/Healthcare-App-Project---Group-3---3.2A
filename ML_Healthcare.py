...
def get_dataset(dataset_name):
    if dataset_name=="Heart Attack":
        data=pd.read_csv("D:\BBIT\Artificial Intelligence\ML-Healthcare-Web-App-main\Data\heart.csv")
        st.header("Heart Attack Prediction")
        return data

    else:
        data=pd.read_csv("D:\BBIT\Artificial Intelligence\ML-Healthcare-Web-App-main\Data\BreastCancer.csv")
